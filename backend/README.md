...
## Project Structure
    ...
    ├── testapiautosetting_125108  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125108`
...
2. Clone this repo and `cd testapiautosetting_125108`
